...
class FileSystem implements FileSystemContract
{
    ...
    public function __construct(FilesystemManager $storage)
    {
        ...
        $this->disk = StorageConfig::defaultDisk();
    }
    ...
    public function store(string|object $file, string $directory = 'images', ?Disk $disk = null): string
    {
        $disk = $disk ?? $this->disk;
    ...
    protected function uniqueName(string|object|null $file, string $fallbackExtension = 'png'): string
    {
    ...
    public function storeAs(string|object $file, string $name, string $directory = 'images', ?Disk $disk = null): string
    {
        $disk = $disk ?? $this->disk;
