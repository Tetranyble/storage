...
The CI matrix covers the PHP/Laravel combinations documented in the README. New framework-major support must be added to `composer.json`, CI, and package migration tests together.
