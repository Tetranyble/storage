...
final class LargeWorkspaceFixture
{
    ...
    public function seed(?int $folderCount = null, ?int $mediaCount = null, ?int $grantCount = null): array
    {
        ...
        $workspace = Workspace::query()->create(['name' => 'Benchmark Workspace']);
        $owner = User::query()->create(['workspace_id' => $workspace->id, 'name' => 'Benchmark Owner']);
        $viewer = User::query()->create(['workspace_id' => $workspace->id, 'name' => 'Benchmark Viewer']);
